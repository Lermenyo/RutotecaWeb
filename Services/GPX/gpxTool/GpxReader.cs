...
namespace Gpx
{
    ...
    public class GpxReader : IDisposable
    {
        ...
        {
            if (Reader_.IsEmptyElement) return String.Empty; //throw new FormatException(Reader_.Name);
        ...
        private int ReadContentAsInt()
        {
            ...
            int salida;
            if (int.TryParse(value, NumberStyles.Integer, CultureInfo.InvariantCulture, out salida))
            {
                return salida;
            }
            else
        ...
        private double ReadContentAsDouble()
        {
            ...
            double salida;
            if (double.TryParse(value, NumberStyles.Float, CultureInfo.InvariantCulture, out salida))
            {
                return salida;
            }
            else
        ...
        private DateTime ReadContentAsDateTime()
        {
            ...
            DateTime salida;
            if (DateTime.TryParse(value,CultureInfo.InvariantCulture,new DateTimeStyles(), out salida))
            {
                return salida;
            }
            else
